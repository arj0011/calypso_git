        ...
        <tbody>
            <tr>
                <td style="text-align:center">
                    <a href="#"><img style=" margin:10px 0px; width:25%;" src="<?php echo base_url().'backend_assets/images/nice_n_easy.png'?>"></a>
                </td>
            </tr>
            <tr>
                <td style="padding:0px;">
                    <table style=" margin:0 auto 5px; display:table; width:100%; color:#666; text-transform:capitalize;">
                        <tr>
                            ...
                            <td style="font-size:14px; padding:2px 8px; color:#000; vertical-align:top;"><?php if(!empty($user) && isset($user)){echo $user;}?></td>
