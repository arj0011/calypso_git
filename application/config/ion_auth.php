...
//$config['tablePrimary']['users']           = 'userId';
//$config['tablePrimary']['groups']          = 'id';
//$config['tablePrimary']['users_groups']    = 'group_id';
//$config['tablePrimary']['login_attempts']  = 'id';
//
//$config['tableCreateOn']['users']           = 'createAt';
...
$config['super_admin_group']          = 'superadmin';    
...
$config['forgot_password_expiration'] = 172800000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire. 48hr
 ...
 */
$config['remember_cookie_name'] = 'remember_code_me';
$config['identity_cookie_name'] = 'identity_by_me';
