<script>
 jQuery('body').on('click', '#submit', function () {
        ...
        $("#"+form_name).validate({
            rules: {
                ...
                item_type: {
                    required: function(element){
                        return $("#category_id").val()=="alla_cart";
                    }
                },
                qr_code:
                {
            ...
            messages: {
                product_name: '<?php echo lang('product_name_validation');?>',
                price: 
                {
                    required: '<?php echo lang('price_validation');?>',
                    number: '<?php echo lang('price_number_validation');?>'
                },
                category_id: '<?php echo lang('category_validation');?>',
               qr_code:
               {
                 required: 'QR Code field is required',
                 maxlength: 'Code should be 6 digit or charcter long',
                 minlength: 'Code should be 6 digit or charcter long'
               }
