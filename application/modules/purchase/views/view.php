              ...
              <div class="row">
               <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control order_date"  name="order_date1" id="order_date1" placeholder="<?=lang('order_date');?>" value="<?php echo $order[0]->order_date; ?>" readonly>
  ...
  <div class="col-sm-12">
    <div class="clearfix" style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; padding:10px 0px; margin-bottom:20px;">
      <div class="col col-md-4 pull-right">
        ...
        <a href="<?php echo base_url('purchase')?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Back</a>
      </div>
    </div>
  </div>
</div>
