        ...
        <div class="ibox-content">
         <div class="row">
          ...
          <div class="col-lg-12" style="overflow-x: auto">
            <table class="table table-bordered table-responsive" id="common_datatable_purchase">
              <thead>
                <tr>
                  ...
                  <th><?php echo lang('order_delivery_date');?></th>
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><?php if($rows->delivered_on=='0000-00-00'){echo '';} else{echo convertDate($rows->delivered_on);}?></td>
                 ...
                 <td>
                   ...
                   <a href="<?php echo site_url('purchase/view_order/'.encoding($rows->id));?>" class="on-default edit-row"><img width="20" src="<?php echo base_url().VIEW_ICON;?>" /></a>
