...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <a href="<?php echo site_url('foodparcel');?>"><?php echo lang('food_items_management').'  /  '.lang('food_parcel');?></a>
      </li>
    </ol>
  </div>
  <div class="col-lg-2">
      ...
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <div class="btn-group " href="#">
            <!-- <a href="javascript:void(0)"  onclick="open_modal('foodparcel')" class="btn btn-primary">
              <?php echo lang('add_food_parcel');?>
              <i class="fa fa-plus"></i>
            </a> -->
            <a href="<?php echo base_url('foodparcel/open_model'); ?>"  class="btn btn-primary">
              <?php echo lang('add_food_parcel');?>
              <i class="fa fa-plus"></i>
            </a>
          </div>
        ...
        <div class="row">
            <div class="col-lg-12">
            <form id="filterform" action="<?php echo base_url('foodparcel');?>" method="post">
              <div class="col-lg-3">
              <!-- <label>Status</label> -->
            ...
            <table class="table table-bordered table-responsive" id="common_datatable_product">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><img width="100" src="<?php if(!empty($rows->image)){echo base_Url().'uploads/foodparcel/'?><?php echo $rows->image;}else{echo base_url().DEFAULT_NO_IMG_PATH;}?>" /></td>
                  <td>
                 ...
                 <td>
                  ...
                  <!--  <a href="javascript:void(0)" class="on-default edit-row" onclick="editFn('foodparcel','item_edit','<?php echo encoding($rows->id)?>');"><img width="20" src="<?php echo base_url().EDIT_ICON;?>" /></a> -->

                  <a href="<?php echo base_url('foodparcel/item_edit');?>/<?php echo encoding($rows->id)?>" class="on-default edit-row"><img width="20" src="<?php echo base_url().EDIT_ICON;?>" /></a>

                   <!-- <a href="javascript:void(0)" onclick="delFn('<?php echo FOODPARCEL;?>','id','<?php echo encoding($rows->id); ?>','foodparcel','del')" class="on-default edit-row text-danger"><img width="20" src="<?php echo base_url().DELETE_ICON;?>" /></a> -->
                  <?php if($rows->status == 1): ?>
                  <a href="<?php echo site_url('offerprice/setpricevariation')?>/foodparcel/<?php echo encoding($rows->id)?>" class="on-default offrprize"><img width="20"/>offer price</a>
                   </td>
                  <?php endif; ?>  
