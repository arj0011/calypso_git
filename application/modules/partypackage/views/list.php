      ...
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <div class="btn-group " href="#">
            <!-- <a href="javascript:void(0)"  onclick="open_modal('partypackage')" class="btn btn-primary">
              <?php echo lang('add_party_package');?>
              <i class="fa fa-plus"></i>
            </a> -->
             <a href="<?php echo base_url('partypackage/open_modal'); ?>"  class="btn btn-primary">
              <?php echo lang('add_party_package');?>
              <i class="fa fa-plus"></i>
            </a>
          </div>
        ...
        <div class="row">
            <div class="col-lg-12">
            <form id="filterform" action="<?php echo base_url('partypackage');?>" method="post">
              <div class="col-lg-3">
              <!-- <label>Status</label> -->
            ...
            <table class="table table-bordered table-responsive" id="common_datatable_product">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><img width="100" src="<?php if(!empty($rows->image)){echo base_Url().'uploads/partypackage/'?><?php echo $rows->image;}else{echo base_url().DEFAULT_NO_IMG_PATH;}?>" /></td>
                  <td>
                 ...
                 <td>
                   ...
                   <!-- <a href="javascript:void(0)" class="on-default edit-row" onclick="editFn('partypackage','item_edit','<?php echo encoding($rows->id)?>');"><img width="20" src="<?php echo base_url().EDIT_ICON;?>" /></a> -->

                   <a href="<?php echo base_url('partypackage/item_edit');?>/<?php echo encoding($rows->id)?>" class="on-default edit-row"><img width="20" src="<?php echo base_url().EDIT_ICON;?>" /></a>


                   <!-- <a href="javascript:void(0)" onclick="delFn('party_package','id','<?php echo encoding($rows->id); ?>','partypackage','del')" class="on-default edit-row text-danger"><img width="20" src="<?php echo base_url().DELETE_ICON;?>" /></a> -->
                  <?php if($rows->status == 1): ?>
                   <a href="<?php echo site_url('offerprice/setpricevariation')?>/partypackage/<?php echo encoding($rows->id)?>" class="on-default offrprize"><img width="20"/>offer price</a>
                 <?php endif; ?>
                   </td>
