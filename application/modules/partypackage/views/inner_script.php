...
$.validator.addMethod('strikeprice',function (value, element) { 
 ...
 jQuery('body').on('click', '#submit', function () {
    ...
    $(document).on('change','.category_cls',function(){
        ...
        if(cat_id != '' && cat_id != null && cat_id != undefined){
            $.ajax({
                method: "POST",
                url: '<?php echo base_url('partypackage/get_items_by_catid')?>',
                data: {id: cat_id,count:count},
                success: function (response) {
                    $('#itemDivId_'+count).html(response);
                },
    ...
    $(document).on('click','.addmorerow',function(){
        ...
        if(category_id != '' && category_id != undefined && category_id != null){
            $.ajax({
                method: "POST",
                url: '<?php echo base_url('partypackage/get_all_items')?>',
        ...
        if(count != 1){
            ...
            if((package_id != '' && package_id != undefined && package_id != null)){
                if(category_id != '' && category_id != undefined && category_id != null){
                   $.ajax({
                        method: "POST",
                        url: "<?php echo base_url('partypackage/delpackagecategory')?>",
...
var statusFun = function (id,status) {   
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    var url = "<?php echo base_url() ?>/partypackage/edit_status";
                    var ctrl = 'partypackage';
                    $.ajax({
                        method: "POST",
                        url: url,
