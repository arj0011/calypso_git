...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('product/product_update') ?>" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-body">
                       ...
                       <div class="col-md-12" >
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('product_name');?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="product_name" id="product_name" placeholder="<?php echo lang('product_name');?>" value="<?php echo $results->product_name;?>" />
                                    </div>
                                    </div>
                                </div>
                                              ...
                                              <span class="glyphicon input_img2 logo_btn" style="display: block;">
                                                ...
                                                <span class="ceo_logo">
                                                    <?php if(!empty($results->image)){ ?>
                                                        <img src="<?php echo base_url().'uploads/product/'.$results->image;?>">
                                                    <?php }else{ ?>
