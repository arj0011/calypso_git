    ...
    <div class="col-lg-12">
            ...
            <form method="post" action="<?=base_url('purchase/add_process');?>" class="form form_product">
              <div class="row">
               <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="order_date1" id="order_date1" value="<?php echo $order[0]->order_date; ?>" readonly>
              ...
              <div class="col-md-6">
               <div class="form-group">
                ...
                <input type="text" class="form-control order_date"  name="order_via" id="order_via" value="<?php echo $order[0]->order_via; ?>"  readonly>
      ...
      <div class="col-md-6">
         <div class="form-group">
          ...
          <input type="text" class="form-control order_phone"  name="remaining_amount" id="remaining_amount" placeholder="<?=lang('remaining_amount');?>" value="<?php echo $order[0]->remaining_amount; ?>" readonly>
        </div>
      </div>

      <div class="col-md-6">
         <div class="form-group">
          <label class="control-label"><?=lang('payed_amount');?></label>

          <input type="text" class="form-control order_phone"  name="payed_amount" id="payed_amount" placeholder="<?=lang('payed_amount');?>" value="<?php echo $order[0]->wallet_payment; ?>" readonly>
        </div>
      </div>

      <div class="col-md-6">
         <div class="form-group">
          <label class="control-label"><?=lang('cash_payment');?></label>

          <input type="text" class="form-control order_phone"  name="cash_payment" id="cash_payment" placeholder="<?=lang('cash_payment');?>" value="<?php echo $order[0]->cash_payment; ?>" readonly>
        </div>
      </div>

       <div class="col-md-6">
         <div class="form-group">
          <label class="control-label"><?=lang('estimated_delivery_date');?></label>

          <input type="text" class="form-control order_phone"  name="estimated_delivery_date" id="estimated_delivery_date" placeholder="<?=lang('estimated_delivery_date');?>" value="<?php echo $order[0]->estimated_delivery_date; ?>" readonly>
        </div>
      </div>
      ...
      <div class="billing_items">
       ...
       <div class="row item-container">
         ...
         <div class="product_name col-md-3"><input type="text" class="product_name form-control" name="product_name[0]" required value="<?php echo $ord->product_name; ?>" readonly>
         <input type="hidden" name="product_id[0]" class="product_id" id="product_id"></div>
         <div class="product_price col-md-2"><input type="text" class="product_price form-control" name="product_price[0]" readonly value="<?php echo $ord->product_price; ?>" >
         </div>

         <div class="product_qua col-md-2"><input type="number" class="qty form-control"  name="product_qty[0]" value="<?php echo $ord->product_qty; ?>" readonly >
         </div>
         <div class="total col-md-2"><input type="text" class="product_total form-control" name="product_total[0]" readonly value="<?php echo $ord->product_total; ?>">
         </div>
     ...
     <div class="row">
      <div class="col-sm-12">
        <div class="clearfix" style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; padding:10px 0px; margin-bottom:20px;">
         ...
         <div class="product_name col-md-2"><input type="text" class="form-control total" value="<?php echo $order[0]->total_price; ?>" readonly ></div>
       </div>
     </div>
   </div>
 </div>
