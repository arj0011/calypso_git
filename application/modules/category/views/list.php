  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="row">
            <div class="col-lg-12">
            <form id="filterform" action="<?php echo base_url('category');?>" method="post">
              <div class="col-lg-3">
              <!-- <label>Status</label> -->
                ...
                <tr>
                 ...
                 <td>
                  <?php if($rows->status == 0) {?>
                    <a href="javascript:void(0)" class="on-default edit-row" onclick="statusChange('<?php echo CATEGORY_MANAGEMENT?>','id','<?php echo encoding($rows->id);?>','<?php echo $rows->status;?>')" title="Active Now"><img width="20" src="<?php echo base_url().INACTIVE_ICON;?>" /></a>
                    <?php } else { ?>
                    <a href="javascript:void(0)" class="on-default edit-row text-danger" onclick="statusChange('<?php echo CATEGORY_MANAGEMENT?>','id','<?php echo encoding($rows->id);?>','<?php echo $rows->status;?>')" title="Inactive Now"><img width="20" src="<?php echo base_url().ACTIVE_ICON;?>" /></a>
                    <?php } ?>
                  </td>
