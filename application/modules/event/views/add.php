                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('event_redirect_url');?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="redirect_url" id="redirect_url" placeholder="<?php echo lang('event_redirect_url');?>" />
                                    </div>
