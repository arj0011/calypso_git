    	...
    	$this->form_validation->set_rules('user_id', 'User Id', 'trim|numeric|required');
          ...
          is_deactive($user_id);
        	...
        	if (!empty($list)) {
          		...
          		/* Get total records */  
          		$total_records = getAllCount(SUGGESTION_FEEDBACK,array('type'=>1,'status'=>1,'user_id'=>$user_id));
      ...
      $this->form_validation->set_rules('user_id', 'User Id', 'trim|numeric|required');
          ...
          is_deactive($user_id);
        	...
        	if (!empty($list)) {
          		...
          		/* Get total records */  
          		$total_records = getAllCount(SUGGESTION_FEEDBACK,array('type'=>2,'status'=>1,'user_id'=>$user_id));
